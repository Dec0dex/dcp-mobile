...
sealed class SuperTokensStatus(val value: String) {
    ...
    data object ResetPasswordInvalidTokenError :
        SuperTokensStatus("RESET_PASSWORD_INVALID_TOKEN_ERROR")
    ...
    data object PasswordlessCodeAlreadyUsedError :
        SuperTokensStatus("USER_INPUT_CODE_ALREADY_USED_ERROR")
    ...
    data object AccountInfoAlreadyAssociatedError :
        SuperTokensStatus("ACCOUNT_INFO_ALREADY_ASSOCIATED_WITH_ANOTHER_PRIMARY_USER_ID_ERROR")

    data object RecipeUserIdAlreadyLinkedWithAnotherPrimaryUserError :
        SuperTokensStatus("RECIPE_USER_ID_ALREADY_LINKED_WITH_ANOTHER_PRIMARY_USER_ID_ERROR")

    data object RecipeUserIdAlreadyLinkedError :
        SuperTokensStatus("RECIPE_USER_ID_ALREADY_LINKED_WITH_PRIMARY_USER_ID_ERROR")
...
fun String.toStatus(): SuperTokensStatus {
    when {
        startsWith("AppId or tenantId not found") ->
            return SuperTokensStatus.AppIdOrTenantIdNotFoundError(this)
    }
    ...
    return when (this) {
        ...
        SuperTokensStatus.ResetPasswordInvalidTokenError.value ->
            SuperTokensStatus.ResetPasswordInvalidTokenError
        SuperTokensStatus.PasswordPolicyViolatedError.value ->
        ...
        SuperTokensStatus.PasswordlessCodeAlreadyUsedError.value ->
            SuperTokensStatus.PasswordlessCodeAlreadyUsedError
        SuperTokensStatus.PasswordlessIncorrectCodeError.value ->
            SuperTokensStatus.PasswordlessIncorrectCodeError
        SuperTokensStatus.PasswordlessExpiredCodeError.value ->
            SuperTokensStatus.PasswordlessExpiredCodeError
        SuperTokensStatus.UnknownPhoneNumberError.value -> SuperTokensStatus.UnknownPhoneNumberError
        SuperTokensStatus.TotpDeviceAlreadyExistsError.value ->
            SuperTokensStatus.TotpDeviceAlreadyExistsError
        ...
        SuperTokensStatus.AccountInfoAlreadyAssociatedError.value ->
            SuperTokensStatus.AccountInfoAlreadyAssociatedError
        SuperTokensStatus.RecipeUserIdAlreadyLinkedWithAnotherPrimaryUserError.value ->
            SuperTokensStatus.RecipeUserIdAlreadyLinkedWithAnotherPrimaryUserError
        SuperTokensStatus.RecipeUserIdAlreadyLinkedError.value ->
            SuperTokensStatus.RecipeUserIdAlreadyLinkedError
