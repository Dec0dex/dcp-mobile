//[composeApp](../../../../index.md)/[net.decodex.dcp.core.supertokens.models](../../index.md)/[AuthFactor](../index.md)/[AllOf](index.md)

# AllOf

[common]\
class [AllOf](index.md)(factors: [AuthFactor](../index.md), val anyOrder: [Boolean](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-boolean/index.html) = true) : [AuthFactor](../index.md)

## Constructors

| | |
|---|---|
| [AllOf](-all-of.md) | [common]<br>constructor(vararg factors: [AuthFactor](../index.md), anyOrder: [Boolean](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-boolean/index.html) = true) |

## Properties

| Name | Summary |
|---|---|
| [anyOrder](any-order.md) | [common]<br>val [anyOrder](any-order.md): [Boolean](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-boolean/index.html) = true |
