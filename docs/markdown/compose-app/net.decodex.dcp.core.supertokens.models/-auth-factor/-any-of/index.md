//[composeApp](../../../../index.md)/[net.decodex.dcp.core.supertokens.models](../../index.md)/[AuthFactor](../index.md)/[AnyOf](index.md)

# AnyOf

[common]\
class [AnyOf](index.md)(factors: [AuthFactor](../index.md)) : [AuthFactor](../index.md)

## Constructors

| | |
|---|---|
| [AnyOf](-any-of.md) | [common]<br>constructor(vararg factors: [AuthFactor](../index.md)) |
